...
namespace BusinessLayer.ValidationRules.BookingValidations
{
    ...
    {  
        public CreateBookingValidation()
        {
            ...
            RuleFor(x => x.Name).MinimumLength(5).WithMessage("Lütfen isim alanına en az 5 karekter veri girişi yapınız").MaximumLength(50).WithMessage("Lütfen isim alanına en fazla 50 karakter veri girişi yapınız.");
